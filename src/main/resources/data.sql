...
insert into student (id, user_id, user_password, name, school_id, coin_id, photo_id, tel, grade, my_class, created_at, updated_at, is_deleted) values (5, 'Cameron', 'gP0<<XJ`bOR''', 'Cinda', 1, 5, 5, '775-365-3814', 1, 1, '2024-10-17 12:33:43', '2024-07-15 21:09:27', false);

insert into follow (id, follower_id, following_id, created_at) values (1, 1, 5, '2024-05-22 20:54:03');
