...
insert into coin (id, my_coin, created_at, updated_at) values (1, 898, '2024-06-29 01:32:39', '2024-06-21 10:49:26');
insert into coin (id, my_coin, created_at, updated_at) values (2, 840, '2024-05-03 16:59:25', '2024-02-14 08:26:46');
insert into coin (id, my_coin, created_at, updated_at) values (3, 852, '2024-10-16 01:57:21', '2024-03-13 08:17:55');
insert into coin (id, my_coin, created_at, updated_at) values (4, 956, '2023-11-14 17:55:06', '2024-03-18 08:25:05');
insert into coin (id, my_coin, created_at, updated_at) values (5, 690, '2024-03-25 21:28:33', '2024-05-28 07:26:59');

insert into photo (id, photo_url, created_at, updated_at) values (1, 'http://dummyimage.com/126x100.png/dddddd/000000', '2023-12-20 15:07:38', null);
insert into photo (id, photo_url, created_at, updated_at) values (2, 'http://dummyimage.com/116x100.png/5fa2dd/ffffff', '2024-07-25 03:06:50', '2024-02-08 03:06:17');
insert into photo (id, photo_url, created_at, updated_at) values (3, 'http://dummyimage.com/156x100.png/ff4444/ffffff', '2024-02-25 23:55:53', null);
...
insert into student (id, user_id, user_password, name, school_id, coin_id, photo_id, tel, grade, my_class, created_at, updated_at, is_deleted) values (2, 'minji', '1234', '서민지', 1, 2, 2, '397-992-0977', 1, 1, '2024-03-15 01:07:48', '2024-08-14 11:15:17', false);
insert into student (id, user_id, user_password, name, school_id, coin_id, photo_id, tel, grade, my_class, created_at, updated_at, is_deleted) values (3, 'inseo', '1234', '박인서', 1, 3, 3, '698-895-8592', 1, 1, '2024-09-22 05:37:18', '2024-08-05 11:34:22', false);
...
insert into student (id, user_id, user_password, name, school_id, coin_id, photo_id, tel, grade, my_class, created_at, updated_at, is_deleted) values (5, 'Cameron', 'gP0<<XJ`bOR''', 'Cinda', 1, 5, 5, '775-365-3814', 1, 1, '2024-10-17 12:33:43', '2024-07-15 21:09:27', true);

insert into follow (id, follower_id, following_id, created_at) values (1, 1, 3, '2024-05-22 20:54:03');
insert into follow (id, follower_id, following_id, created_at) values (2, 1, 2, '2024-01-20 15:04:37');
insert into follow (id, follower_id, following_id, created_at) values (3, 2, 1, '2024-04-21 06:41:32');
insert into follow (id, follower_id, following_id, created_at) values (4, 3, 1, '2023-11-30 00:34:41');
insert into follow (id, follower_id, following_id, created_at) values (5, 5, 2, '2024-03-04 13:42:45');
